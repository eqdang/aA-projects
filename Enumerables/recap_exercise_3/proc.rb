...
# return a new string containing characters of the original string that return true when passed into 
# the block. If no block is passed, then return the empty string. Do not use the built-in Array#select 
# in your solution.
