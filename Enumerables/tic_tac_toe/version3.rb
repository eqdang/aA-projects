...
=> [[0, 0], [1, 0], [1, 1]]
Let's also test our humans. Since #getPositions simply expects an array as itcome from any board. Don't fs argument, we can pass in some "mock" data that doesn't really orget that abstraction is a pillar of object oriented programming. Our #getPositions just cares about being given an array, it doesn't care exactly where that array comes from:
